...
class Stemmer {
	...
	public static String stemmedOutPut(String text, boolean toLowerCase) throws FileNotFoundException {
...
//						System.out.print((char) ch);
		...
		// pw.close();
//		 System.out.println("after stemmer sb.ToString="+sb.toString());
		return sb.toString();
...
//		String localPath = "c:/getContracts/";
		...
		String text = "this has been predetermined - was prefix removed?";
//		text = stemmedOutPut(text);
