...
public class StanfordLemmatizer {
    ...
    public static void main(String[] args) throws FileNotFoundException {
    	...
    	PrintWriter pw = new PrintWriter(new File("c:/getContracts/temp/tmpLemmatizer.txt"));
        ...
        text =  "Failure by the Trustee or the Collateral Trustee, as applicable, to so notify "
				+ "the Issuers will not relieve the Issuers or any of the Guarantors of their obligations hereunder.";
