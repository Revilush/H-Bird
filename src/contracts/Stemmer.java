...
public class Stemmer {
	...
	private final void step1() {
		...
		// what about indemnified - which will then be indemnifi - and
		// thereafter not get shortened. Maybe here I remove all instances of
		// ified? such as exemplified
	...
	public static String stemmedOutPutWithPunctuationRemoved(String text) throws FileNotFoundException {

		text = text.replaceAll("[^a-zA-Z\\d ]", "");
		
		// this will run the stemmer logic above to produce the stemmed word
		// output saved to a file.
		
		// TODO: Can remove PrintWriter once testing is complete.

//		System.out.println("stemmedOutPut file=" + file.getAbsolutePath());
		int cnt=0;
//		File fileStemmed = new File(localPath
//				+ file.getName().substring(0, file.getName().lastIndexOf("."))
//				+ "_stem.txt");
		
//		PrintWriter pw = new PrintWriter(fileStemmed);
		StringBuffer sb = new StringBuffer();

		// System.out.println("localPath+file.getName()" + localPath
		// + file.getName().substring(0, file.getName().lastIndexOf("."))
		// + "_stem.txt");
		...
		boolean newContract = false;
		{
			...
			try {
...

				{
					...
					// System.out.println("xx="+Character.valueOf((char)ch));
...
//						System.out.print((char) ch);
	...
	public static String stemmedOutPutPorter(String text) throws FileNotFoundException {
...
//		File file = new File("c:/getContracts/tmp.txt");
//		String localPath = "c:/getContracts/";

		String text = "this attorney advance advise advisor adviser construction supervise supervision supervising";
		
//		text = Stemmer.stemmedOutPutWithPunctuationRemoved(StopWords.removeStopWords(text));
//		text = Stemmer.stemmedOutPutPorter("attorney");
		// if attornei - then b/c it is not a subset of attorney stem-attorney.
//		System.out.println(text);
		GoLaw gl = new GoLaw();
		System.out.println(gl.goLawStemmer(text));
